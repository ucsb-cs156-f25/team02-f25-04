...
public class ArticlesControllerTests extends ControllerTestCase {
  ...
  public void logged_in_user_can_get_all_articles() throws Exception {
    ...
    Article article1 =
        Article.builder()
            .title("firstArticle")
            .url("first-article.com")
            .explanation("first article")
            .email("first@article.com")
            .dateAdded(ldt1)
            .build();
    ...
    Article article2 =
        Article.builder()
            .title("secondArticle")
            .url("second-article.com")
            .explanation("second article")
            .email("second@article.com")
            .dateAdded(ldt2)
            .build();
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=firstArticle&url=first-article.com&explanation=first article&email=first@article.com&dateAdded=2022-01-03T00:00:00")
                    .with(csrf()))
  ...
  public void admin_can_edit_an_existing_article() throws Exception {
    ...
    Article articleOrig =
        Article.builder()
            .title("origArticle")
            .url("orig-article.com")
            .explanation("orig article")
            .email("orig@article.com")
            .dateAdded(ldt1)
            .build();
    ...
    Article articleEdited =
        Article.builder()
            .title("editedArticle")
            .url("edited-article.com")
            .explanation("edited article")
            .email("edited@article.com")
            .dateAdded(ldt2)
            .build();
