...
public class MenuItemReviewControllerTests extends ControllerTestCase {
  ...
  public void logged_in_user_can_get_all_menuitemreviews() throws Exception {
    ...
    ArrayList<MenuItemReview> expectedMenuReviewItems = new ArrayList<>();
    expectedMenuReviewItems.addAll(Arrays.asList(menuItemReview1, menuItemReview2));

    when(menuItemReviewRepository.findAll()).thenReturn(expectedMenuReviewItems);
    ...
    String expectedJson = mapper.writeValueAsString(expectedMenuReviewItems);
    String responseString = response.getResponse().getContentAsString();
    assertEquals(expectedJson, responseString);
  }
  ...
  public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreview/post?itemId=30&reviewerEmail=carumugam@ucsb.edu&stars=1&comments=tastes_bad&dateReviewed=2022-01-03T00:00:00")
                    .with(csrf()))
