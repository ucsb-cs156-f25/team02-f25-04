...
public class ArticleWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_article() throws Exception {
    ...
    page.getByTestId("ArticleForm-title").fill("test1");
    page.getByTestId("ArticleForm-url").fill("test.com");
    page.getByTestId("ArticleForm-explanation").fill("test");
    page.getByTestId("ArticleForm-email").fill("test@test.com");
    page.getByTestId("ArticleForm-dateAdded").fill("2022-01-03T00:00");
    page.getByTestId("ArticleForm-submit").click();

    assertThat(page.getByTestId("ArticleTable-cell-row-0-col-title")).hasText("test1");

    page.getByTestId("ArticleTable-cell-row-0-col-Edit-button").click();
    assertThat(page.getByText("Edit Article")).isVisible();
    page.getByTestId("ArticleForm-explanation").fill("testUpdated");
    page.getByTestId("ArticleForm-submit").click();

    assertThat(page.getByTestId("ArticleTable-cell-row-0-col-explanation")).hasText("testUpdated");
